'''This is the database module that holds all the database logic for Dojo'''
...
class Database:
    ...
    def clear(self):
        '''Clear database tables so as to save Dojo's state afresh'''
